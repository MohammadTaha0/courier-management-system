...
<body>
    ...
    <div class="container-fluid position-absolute" style="z-index: 9999999;">
        <div class="card w-25 py-3" style="width: 18rem;">
            <div class="card-body text-center">
                <h5 class="card-title h6">Select Courier Status</h5>
                <form action="" method="POST">
                    ...
                    <a href="viewdetails.php?id=<?php echo $_GET['id']; ?>" type="submit" class="btn btn-secondary">Close</a>
                </form>
                <?php
                if (isset($_POST['submit'])) {
                    $id = $_GET['id'];
                    $status = $_POST['status'];
                    $query = mysqli_query($con, "UPDATE `tbl_courier` SET `status`='$status' WHERE `id`='$id'");
                    if ($query) {
                ?>
                        <script>
                            window.location.href = "viewdetails.php?id=<?php echo $id; ?>";
                        </script>
                <?php
                    }
                }
