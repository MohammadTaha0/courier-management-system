            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    <a href="index.php" class="navbar-brand mx-4 mb-3">
                        <h3 class="text-primary"><i class="fa-light fa-box-open me-2"></i>Tcourier</h3>
                    </a>
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu bg-transparent border-0 toggle0">
                                <a href="editbranch.php" class="dropdown-item active">Edit Branch</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    ...
                    <div class="container">
                        ...
                        $select = "SELECT * FROM `tbl_branch` WHERE `id`='$agent_branch_id'";
                        ...
                        <form action="" method="POST">
                            <div class="row">
                                <div class="mb-3 col-6">
                                    <label for="exampleInputEmail1" class="form-label">Street/Building</label>
                                ...
                                <div class="mb-3 col-6">
                                    <label for="exampleInputEmail1" class="form-label">Zip Code/ Postal Code</label>
                                    <input type="text" class="form-control" name="zip" value="<?php echo $row['zip_code']; ?>">
                                </div>
                                <div class="mb-3 col-6">
                                    <label for="exampleInputEmail1" class="form-label">Country</label>
                                    <input type="text" value="<?php echo $row['country']; ?>" class="form-control" name="country">
                                </div>
                                <div class="mb-3 col-6">
                            ...
                            <div>
                                <button type="submit" name="submit" class="btn btn-primary mt-3">Edit Branch</button>
                            </div>
                        </form>
                    </div>
                    <?php
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "UPDATE `tbl_branch` SET `address`='$address',`city`='$city',`state`='$state',`zip_code`='$zip',`country`='$country',`contact`='$contact' WHERE `id`='$agent_branch_id'";
