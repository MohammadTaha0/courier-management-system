                ...
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" onclick="toggle(0)"><i class="fa-regular fa-buildings me-2 active"></i>Branch</a>
                            <div class="dropdown-menu bg-transparent border-0 toggle0">
                                <a href="newbranch.php" class="dropdown-item active">Add New</a>
                ...
                <div class="bg-light rounded p-4">
                    ...
                    <div class="container">
                        <form action="" method="POST">
                            ...
                            <div>
                                <button type="submit" name="submit" class="btn btn-primary mt-3">Add Branch</button>
                            </div>  
                        </form>
                    </div>
                    <?php
                    if(isset($_POST['submit']))
                    {
                        ...
                        $sql = "INSERT INTO `tbl_branch`(`branch_code`,`address`,`city`,`state`,`zip_code`,`country`,`contact`,`date_created`) VALUES('$branch_code','$address','$city','$state','$zip','$country','$contact',CURDATE())";
