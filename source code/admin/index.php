                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total Couriers</p>
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `id`";
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_register` WHERE `userrole`='1'";
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='1'"; // collected = 1
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='2'"; // shipped = 2
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='3'"; // in-transit = 3
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='4'"; // at destination = 4
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='5'"; // out for delivery = 5
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='6'"; // to pickup = 6
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='7'"; // deliverrd = 7
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='0'"; // accrpt by courier = 0
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='8'"; // total picked-up = 8
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><?php
                                                    $sql = "SELECT * FROM `tbl_courier` WHERE `status`='9'"; // unsuccessfull delivery = 9
                                                    $query = mysqli_query($con, $sql);
                                                    $num = mysqli_num_rows($query);
                                                    echo $num;
                                                    ?></h6>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0 text-center table-hover">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM `tbl_Courier` Order by `id` desc limit 5";
                                $query = mysqli_query($con, $sql);
