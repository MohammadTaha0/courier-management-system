                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0 toggle0">
                                ...
                                <a href="listbranch.php" class="dropdown-item active">All Branches</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <form action="" method="POST" class="col-7 d-flex justify-content-end">
                            <input type="text" class="form-control w-50" placeholder="Search By Branch Code" onkeyup="branch_code()" name="br_search">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0 text-center table-hover">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                    $br_key = $_POST['br_search'];
                                    $query = mysqli_query($con, "SELECT * FROM `tbl_branch` WHERE `branch_code`='$br_key'");
                                    if (mysqli_num_rows($query) > 0) {
                                        while ($srch_fet = mysqli_fetch_array($query)) {
                                ?>
                                            <tr>
                                                <td><?php echo $srch_fet['id']; ?></td>
                                                <td><?php echo $srch_fet['branch_code']; ?></td>
                                                <td><?php echo $srch_fet['address']; ?></td>
                                                <td><?php echo $srch_fet['city'] . ', ' . $srch_fet['state'] . ', ' . $srch_fet['zip_code']; ?></td>
                                                <td><?php echo $srch_fet['country']; ?></td>
                                                <td><?php echo $srch_fet['contact']; ?></td>
                                                <td>
                                                    <a class="btn btn-sm btn-success p-2 m-0 me-0" href="editbranch.php?id=<?php echo $srch_fet['id']; ?>"><i class="fa-regular fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-danger p-2 m-0 me-0" href="deletebranch.php?id=<?php echo $srch_fet['id']; ?>"><i class="fa-regular fa-trash"></i></a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-danger p-2 m-0 me-0" href="deletebranch.php?id=<?php echo $res['id']; ?>"><i class="fa-regular fa-trash"></i></a>
                                                </td>
                                            </tr>
                                <?php
                                        }
