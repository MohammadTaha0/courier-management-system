                ...
                <div class="bg-light rounded p-4">
                    ...
                    <div class="container">
                        <form action="" method="POST">
                            ...
                            <div>
                                <button type="submit" name="submit" class="btn btn-primary mt-3">Add agent</button>
                            </div>
                        </form>
                    </div>
                    <?php
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "INSERT INTO `tbl_register`(`firstname`,`lastname`,`email`,`password`,`userrole`,`branch_id`,`date_created`) VALUES('$firstname','$lastname','$email','$password','1','$branch',CURDATE())";
