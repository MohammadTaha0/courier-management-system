                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0 toggle3">
                                ...
                                <a href="listagents.php" class="dropdown-item active">All Agents</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                $br_id = $res['branch_id'];
                                                $branch_select = "SELECT * FROM `tbl_branch` WHERE `id`='$br_id'";
                                                $br_query = mysqli_query($con, $branch_select);
                                                $br_res = mysqli_fetch_assoc($br_query);
                                                echo $br_res['city'] . ', ' . $br_res['state'] . ', ' . $br_res['zip_code'];

                                                ?></td>
                                            <td>
                                                <a class="btn btn-sm btn-success p-2 m-0 me-0" href="editagent.php?id=<?php echo $res['id']; ?>"><i class="fa-regular fa-edit"></i></a>
                                                <a class="btn btn-sm btn-danger p-2 m-0 me-0" href="deleteagent.php?id=<?php echo $res['id']; ?>"><i class="fa-regular fa-trash"></i></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
