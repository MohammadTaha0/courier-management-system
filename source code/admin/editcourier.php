...
$editid = $_GET['id'];
$fetch = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `tbl_courier` WHERE `id`='$editid'"));
?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <input type="text" class="form-control" name="sendername" value="<?php echo $fetch['sender_name']; ?>">
                                    </div>
                                    <div class="mb-3 col-12">
                                        <label for="exampleInputEmail1" class="form-label">Address</label>
                                        <input type="text" class="form-control" name="sendaddress" value="<?php echo $fetch['sender_address']; ?>">
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <div>
                                            <select class="form-select" name="type" id="select">
                                                <option value="1" <?php if ($fetch['type'] == 1) {
                                                                        echo "selected";
                                                                    }  ?> class="opt1">Pickup</option>
                                                <option value="2" <?php if ($fetch['type'] == 2) {
                                                                        echo "selected";
                                                                    }  ?> class="opt2">Deliver</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-12">
                                        <label for="exampleInputEmail1" class="form-label">Contact #</label>
                                        <input type="text" class="form-control" name="sendcontact" value="<?php echo $fetch['sender_contact']; ?>">
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <select name="email" class="form-select">
                                            ...
                                            ?>
                                                <option value="<?php echo $emailfet['email']; ?>" <?php if ($emailfet['email'] == $fetch['email']) {
                                                                                                        echo "selected";
                                                                                                    } ?>><?php echo $emailfet['email']; ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="mb-3 col-12">
                                        <label for="exampleInputEmail1" class="form-label">Name</label>
                                        <input type="text" class="form-control" name="recname" value="<?php echo $fetch['recipitent_name']; ?>">
                                    </div>
                                    <div class="mb-3 col-12">
                                        <label for="exampleInputEmail1" class="form-label">Address</label>
                                        <input type="text" class="form-control" name="recaddress" value="<?php echo $fetch['recipient_address']; ?>">
                                    </div>
                                    <div class="mb-3 col-12">
                                        <label for="exampleInputEmail1" class="form-label">Contact #</label>
                                        <input type="text" class="form-control" name="reccontact" value="<?php echo $fetch['recipient_address']; ?>">
                                    </div>
                                    <div class="mb-3 col-12">
                                        ...
                                        <select class="form-select" name="probranch">
                                            ...
                                            ?>
                                                    <option <?php if ($fetch['to_branch_id'] == $row['id']) {
                                                                echo "selected";
                                                            } ?> value="<?php echo $row['id']; ?>"><?php echo  $row['city'] . '/' . $row['state'] . '/' . $row['zip_code'] . '/' . $row['country'] . '/' . $row['date_created']; ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <div class="mb-3 col-12" id="pickup_branch">
                                            ...
                                            <select class="form-select" name="pickbranch">
                                                ...
                                                if (mysqli_num_rows($query) > 0) {
                                                    while ($row = mysqli_fetch_assoc($query)) {
                                                ?>
                                                        <option <?php if ($fetch['from_branch_id'] == $row['id']) {
                                                                    echo "selected";
                                                                } ?> value="<?php echo $row['id']; ?>"><?php echo  $row['city'] . '/' . $row['state'] . '/' . $row['zip_code'] . '/' . $row['country'] . '/' . $row['date_created']; ?></option>
                                                <?php
                                                    }
                                ...
                                <div class="col-12 my-4">
                                    <h6 class="text-secondary">Parcel Information</h5>
                                        <table class="align-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" class="form-control" name="weight" value="<?php echo $fetch['weight']; ?>"></td>
                                                    <td><input type="text" name="height" class="form-control" value="<?php echo $fetch['height']; ?>"></td>
                                                    <td><input type="text" name="lenght" class="form-control" value="<?php echo $fetch['lenght']; ?>"></td>
                                                    <td><input type="text" name="width" class="form-control" value="<?php echo $fetch['width']; ?>"></td> 
                                                    <td><input type="text" name="price" class="form-control" value="<?php echo $fetch['price']; ?>" id="ppinp" onkeyup="pprice()"></td>
                                                </tr>
                                                <tr class="text-end">
                                                    <td colspan="4">Total</td>
                                                    <td id="dispplaytd" style="overflow: hidden;">
                                                        <?php echo $fetch['price']; ?><script>
                                                            function pprice() {
                    ...
                    SET
                        ...
                        `sender_contact` = '$sendcontact',
                        `recipitent_name` = '$recname',
                        `recipient_address` = '$recaddress',
                        `recipient_contact` = '$reccontact',
                        `type` = '$type',
                        `from_branch_id` = '$pickbranch',
                        `to_branch_id` = '$probranch',
                        `weight` = '$weight',
                        `height` = '$height',
                        `width` = '$width',
                        `lenght` = '$lenght',
