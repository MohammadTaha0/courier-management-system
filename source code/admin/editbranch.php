            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    ...
                    <div class="container">
                        <?php 
                        $id = $_GET['id'];
                        $select = "SELECT * FROM `tbl_branch` WHERE `id`='$id'";
                        ...
                        <form action="" method="POST">
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" maxlength="11" name="contact" value="<?php echo $row['contact'];?>">
                                </div>
                            </div>
                            <div>
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $sql = "UPDATE `tbl_branch` SET `address`='$address',`city`='$city',`state`='$state',`zip_code`='$zip',`country`='$country',`contact`='$contact' WHERE `id`='$id'";
